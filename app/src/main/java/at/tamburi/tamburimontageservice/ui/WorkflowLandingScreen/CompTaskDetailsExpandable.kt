    ...
    ExpandableCard(title = stringResource(id = R.string.wf_title), description = "", expanded = true) {
        Column {
            TwoLineItem(
                ...
                cell2 = task.montageId.toString()
            )
            TwoLineItem(
                cell1 = stringResource(id = R.string.wf_address),
                cell2 = "${task.remoteLocation.streetName} " +
                        task.remoteLocation.streetNumber
            )
            TwoLineItem(
                cell1 = stringResource(id = R.string.wf_zip),
                cell2 = task.remoteLocation.zipCode
            )
            TwoLineItem(
            ...
            TwoLineItem(
                ...
                cell2 = task.montageGround.type
            )
            TwoLineItem(
                cell1 = stringResource(id = R.string.wf_scheduled_date),
                cell2 = task.scheduledInstallation.toString()
            )
        }
    }
}